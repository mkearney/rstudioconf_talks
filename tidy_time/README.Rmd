...
+ [business-science/tibbletime](https://github.com/business-science/tibbletime): 
            Time-aware tibbles
...
+ `tibbletime::collapse_by()`: Collapse a tbl_time object by its index Collapse the index of a tbl_time object by time period. The index column
is altered so that all dates that fall in a specified interval share a
common date.


+ `tibbletime::rollify()`: Create a rolling version of any function rollify returns a rolling version of the input function, with a
